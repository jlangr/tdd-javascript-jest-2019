...
describe('a name normalizer', () => {
  ...
  it('trims leading and trailing whitespace for mononym', () => {
    expect(normalize('  Madonna   ')).toEqual('Madonna')
  })
  ...
  it('appends suffixes to end of mononym', () => {
    expect(normalize('Madonna, Esq.')).toEqual('Madonna, Esq.')
  })
